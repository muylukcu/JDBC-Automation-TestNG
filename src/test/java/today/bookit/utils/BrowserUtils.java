...
public class BrowserUtils {
	...
	/**
	 * Generates the String path to the screenshot taken. Within the method, the
	 * screenshot is taken and is saved into FileUtils. The String return will have
	 * a unique name destination of the screenshot itself.
	 *
